...
to a list, delivery_id_confirmations. When the drone comes back and lands, the
ID is again added to the same list.
...
def test():
    ...
    assert find_missing_drone([21,33,21,45,78,89,45,33,89,78]) == 0
